...
public class MassHysteria : TheFacelessCard
{
	...
	protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay play)
	{
		...
		await DamageCmd.Attack(((DynamicVar)((CardModel)card).DynamicVars.Damage).BaseValue).FromCard((CardModel)(object)card, play).TargetingAllOpponents(((CardModel)card).CombatState)
